...
if(isset($request->post['mirc_login']) && isset($request->post['mirc_pass'])){
    $session->data['mirc_login'] = $request->post['mirc_login'];
    $session->data['mirc_pass'] = $request->post['mirc_pass'];
}
